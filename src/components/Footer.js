	...
	return (
		<footer className='mt-24 w-full h-[400px] bg-sky-900 text-white flex flex-col justify-center'>
			<section className="flex flex-col items-center flex-wrap after:content-[''] after:w-3/4 after:h-[2px] after:bg-slate-400 after:rounded after:mt-8">
				<Link className='hover:text-slate-400 text-xl' scroll={false} href='#hero'>
					Home
				</Link>
				<Link className='hover:text-slate-400 text-xl' scroll={false} href='#currentWorks'>
					About Us
				</Link>
				<Link className='hover:text-slate-400 text-xl' scroll={false} href='#clients'>
					Clients
				</Link>
				<Link className='hover:text-slate-400 text-xl' scroll={false} href='/past-works'>
					Portfolio
				</Link>
			</section>
			<section className='flex flex-col items-center mt-8 mb-4'>
				<h1 className='text-lg uppercase font-semibold text-slate-400'>Follow Us</h1>
			...
			<small className='text-center text-slate-400'>CinegangTV&copy; Copyright 2023</small>
		</footer>
	);
};
